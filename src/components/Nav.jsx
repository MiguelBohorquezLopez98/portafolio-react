function Nav() {
    let title = "Miguel Eduardo Bohórquez López"
    return (
        <nav className="bg-cyan-500 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
